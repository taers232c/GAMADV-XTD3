...
c:\python37-32\scripts\pyinstaller --clean --noupx -F --distpath=gamadv-xtd3 windows-gam.spec
...
c:\python37-64\scripts\pyinstaller --clean --noupx -F --distpath=gamadv-xtd3-64 windows-gam.spec
