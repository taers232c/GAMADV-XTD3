...
EXISTING_ENTITY_VALUE = u'existing {0} {1}'
EXISTS = u'Exists'
EXPECTED = u'Expected'
...
NOT_COPYABLE_SAME_NAME_CURRENT_FOLDER_OVERWRITEEXISTING = u'Not copyable with same name into current folder with overwriteexisting'
NOT_DELETABLE = u'Not deletable'
NOT_FOUND = u'Not Found'
NOT_MOVABLE_SAME_NAME_CURRENT_FOLDER = u'Not movable with same name into current folder'
...
STATISTICS_FOLDER = u'Total: {0}, Copied to new: {1}, Copied to existing: {2}, Copy Failed: {3}, Not writable: {4}, Permissions Failed: {5}'
STATISTICS_FILE = u'Total: {0}, Copied: {1}, Duplicate: {2}, Copy Failed: {3}, Not copyable: {4}, Permissions Failed: {5}'
