...
API_CHECK_CLIENT_AUTHORIZATION = u'Please make sure the Client ID: {0} is authorized for the appropriate scopes:\n{1}\n\nRun: gam oauth info\n'
API_CHECK_SVCACCT_AUTHORIZATION = u'Please make sure the Service Account Client name: {0} is authorized for the appropriate scopes:\n{1}\n\nRun: gam user {2} check serviceaccount\n'
API_ERROR_SETTINGS = u'API error, some settings not set'
API_CALLS_RETRY_DATA = u'API calls retry data\n'
...
DOMAIN_NOT_FOUND_IN_DNS = u'Domain not found in DNS!'
...
EXISTS = u'Exists'
EXPECTED = u'Expected'
EXPORT_NOT_COMPLETE = u'Export needs to be complete before downloading, current status is: {0}'
...
GOT = u'Got'
GROUP_MAPS_TO_OU_INVALID_ROW = u'File: {0}, Invalid row, must contain non-blank <EmailAddress> and <OrgUnitPath>: <{1}> <{2}>'
GROUP_MAPS_TO_MULTIPLE_OUS = u'File: {0}, Group: {1} references multiple OUs: {2}'
GUARDIAN_INVITATION_STATUS_NOT_PENDING = u'Guardian invitation status is not PENDING'
HAS_CHILD_ORGS = u'Has child {0}'
HAS_INVALID_FORMAT = u'{0}: {1}, Has invalid format'
...
INTER_BATCH_WAIT_INCREASED = u'inter_batch_wait increased to {0:.2f}'
INVALID = u'Invalid'
INVALID_ALIAS = u'Invalid Alias'
INVALID_ENTITY = u'Invalid {0}, {1}'
INVALID_GROUP = u'Invalid Group'
INVALID_JSON_INFORMATION = u'Google API reported Invalid JSON Information'
INVALID_JSON_SETTING = u'Invalid JSON setting'
INVALID_MEMBER = u'Invalid Member address'
INVALID_MESSAGE_ID = u'Invalid message id(s)'
INVALID_MIMETYPE = u'Invalid mimeType {0}, must be {1}'
INVALID_ORGUNIT = u'Invalid Organizational Unit'
INVALID_PATH = u'Invalid Path'
INVALID_PERMISSION_ATTRIBUTE_TYPE = u'permission attribute {0} not allowed with type {1}'
...
INVALID_TAG_SPECIFICATION = u'Invalid tag, expected field.subfield or field.subfield.subfield.string'
INVALID_TIME_RANGE = u'{0} {1} must be greater than/equal to {2} {3}'
IN_SKIPIDS = u'In skipids'
...
MATTER_NOT_OPEN = u'Matter needs to be open, current state is: {0}'
...
MULTIPLE_BUILDINGS_SAME_NAME = u'{0} {1} with the same (case-insensitive) name exist'
MULTIPLE_ENTITIES_FOUND = u'Multiple {0} ({1}) found, {2}'
MULTIPLE_ITEMS_MARKED_PRIMARY = u'Multiple {0} are marked primary, only one can be primary'
MULTIPLE_PARENTS_SPECIFIED = u'Multiple parents ({0}) specified, only one is allowed'
MULTIPLE_SEARCH_METHODS_SPECIFIED = u'Multiple search methods ({0}) specified, only one is allowed'
MUST_BE_NUMERIC = u'Must be numeric'
NEED_READ_ACCESS = u'Need Read access'
NEED_READ_WRITE_ACCESS = u'Need Read/Write access'
...
NEWUSER_REQUIREMENTS = u'newuser option requires: 1 recipient and givenname, familyname and password options'
...
NOT_COPYABLE_SAME_NAME_CURRENT_FOLDER_MERGE = u'Not copyable with same name into current folder with duplicatefolders merge'
NOT_COPYABLE_SAME_NAME_CURRENT_FOLDER_OVERWRITE = u'Not copyable with same name into current folder with duplicatefiles overwriteall|overwriteolder'
NOT_DELETABLE = u'Not deletable'
NOT_FOUND = u'Not Found'
NOT_MOVABLE = u'Not Movable'
NOT_MOVABLE_IN_TRASH = u'Not Movable, in Trash'
NOT_MOVABLE_SAME_NAME_CURRENT_FOLDER_MERGE = u'Not movable with same name into current folder with duplicatefolders merge'
NOT_MOVABLE_SAME_NAME_CURRENT_FOLDER_OVERWRITE = u'Not movable with same name into current folder with duplicatefiles overwriteall|overwriteolder'
...
NO_DATA_TRANSFER_APP_FOR_PARAMETER = u'No data transfer application for key {0}'
...
NO_TRANSFER_LACK_OF_DISK_SPACE = u'Transfer not performed due to lack of target drive space.'
...
OR = u'or'
PERMISSION_DENIED = u'The caller does not have permission'
PLEASE_SELECT_ENTITY_TO_PROCESS = u'{0} {1} found, please select the correct one to {2} and specify with {3}'
PLEASE_SPECIFY_BUILDING_EXACT_CASE_NAME_OR_ID = u'Please specify building by exact case name or ID.'
PREVIEW_ONLY = u'Preview Only'
PRIMARY_EMAIL_DID_NOT_MATCH_PATTERN = u'primaryEmail address did not match pattern: {0}'
PROCESS = u'process'
...
STATISTICS_COPY_FOLDER = u'Total: {0}, Copied: {1}, Duplicate: {2}, Merged: {3}, Copy Failed: {4}, Not writable: {5}, Permissions Failed: {6}'
STATISTICS_COPY_FILE = u'Total: {0}, Copied: {1}, Duplicate: {2}, Copy Failed: {3}, Not copyable: {4}, Permissions Failed: {5}'
STATISTICS_MOVE_FOLDER = u'Total: {0}, Moved: {1}, Duplicate: {2}, Merged: {3}, Move Failed: {4}, Not writable: {5}'
STATISTICS_MOVE_FILE = u'Total: {0}, Moved: {1}, Duplicate: {2}, Move Failed: {3}, Not movable: {4}'
...
THREADS = u'threads'
TO = u'To'
TOTAL_ITEMS_IN_ENTITY = u'Total {0} in {1}'
UNABLE_TO_GET_PERMISSION_ID = u'Unable to get Permission ID for <{0}>'
UNAVAILABLE = u'Unavailable'
UNKNOWN = u'Unknown'
UNKNOWN_API_OR_VERSION = u'Unknown Google API or version: ({0}), contact {1}'
UNRECOVERABLE_ERROR = u'Unrecoverable error'
UPDATE_USER_PASSWORD_CHANGE_NOTIFY_MESSAGE = u'The account password for #givenname# #familyname#, #user# has been changed to: #password#\n'
UPDATE_USER_PASSWORD_CHANGE_NOTIFY_SUBJECT = u'Account #user# password has been changed'
USER_BELONGS_TO_N_GROUPS_THAT_MAP_TO_ORGUNITS = u'User belongs to {0} groups ({1}) that map to OUs'
USER_IN_OTHER_DOMAIN = u'{0}: {1} in other domain.'
USER_SUBS_NOT_ALLOWED_TAG_REPLACEMENT = u'user substitutions not allowed in replace <Tag> <String>'
