...
NOT_MOVABLE_SAME_NAME_CURRENT_FOLDER_OVERWRITE = u'Not movable with same name into current folder with duplicatefiles overwriteall'
...
STATISTICS_COPY_FOLDER = u'Total: {0}, Copied: {1}, Merged: {2}, Copy Failed: {3}, Not writable: {4}, Permissions Failed: {5}'
STATISTICS_COPY_FILE = u'Total: {0}, Copied: {1}, Duplicate: {2}, Copy Failed: {3}, Not copyable: {4}, Permissions Failed: {5}'
STATISTICS_MOVE_FOLDER = u'Total: {0}, Moved: {1}, Merged: {2}, Move Failed: {3}, Not writable: {4}'
