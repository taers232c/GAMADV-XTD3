...
COMMIT_BATCH_COMPLETE = u'commit-batch - running processes finished, proceeding\n'
...
NOT_A_GUARDIAN_OR_INVITATION = u'Not a Guardian or Guardian Invitation'
...
USING_N_PROCESSES = u'Using {0} processes...\n'
WAITING_FOR_PROCESSES_TO_COMPLETE = u'Waiting for running processes to finish before proceeding...'
WITH = u'with'
