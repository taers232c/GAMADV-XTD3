...
GROUP_LIST_RETRY_REASONS = [RESOURCE_NOT_FOUND, DOMAIN_NOT_FOUND, FORBIDDEN, BAD_REQUEST]
GROUP_LIST_USERKEY_RETRY_REASONS = GROUP_LIST_RETRY_REASONS+[INVALID_MEMBER, INVALID_INPUT]
