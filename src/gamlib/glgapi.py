...
DRIVE_ACCESS_THROW_REASONS = [FILE_NOT_FOUND, FORBIDDEN, INTERNAL_ERROR, INSUFFICIENT_FILE_PERMISSIONS, UNKNOWN_ERROR]
DRIVE_COPY_THROW_REASONS = DRIVE_USER_THROW_REASONS+DRIVE_ACCESS_THROW_REASONS+[CANNOT_COPY_FILE]
...
SHEETS_ACCESS_THROW_REASONS = [NOT_FOUND, FORBIDDEN, INTERNAL_ERROR, INSUFFICIENT_FILE_PERMISSIONS, BAD_REQUEST]
