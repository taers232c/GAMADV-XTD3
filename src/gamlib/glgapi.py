...
GROUP_SETTINGS_THROW_REASONS = [NOT_FOUND, GROUP_NOT_FOUND, DOMAIN_NOT_FOUND, DOMAIN_CANNOT_USE_APIS, FORBIDDEN, SYSTEM_ERROR, PERMISSION_DENIED, INVALID, INVALID_ATTRIBUTE_VALUE, INVALID_INPUT, SERVICE_LIMIT]
