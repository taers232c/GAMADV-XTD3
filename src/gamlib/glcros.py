...
"""GAM ChromeOS TPM/Auto Update Expiration processing
...
def guessAUE(cros, guessedAUEs):
  crosModel = cros.get('model')
  if crosModel:
    if crosModel not in guessedAUEs:
      closest_match = difflib.get_close_matches(crosModel, _CROS_AUE_DATES, n=1)
      if closest_match:
        guessedAUEs[crosModel] = {'guessedAUEDate': _CROS_AUE_DATES[closest_match[0]],
