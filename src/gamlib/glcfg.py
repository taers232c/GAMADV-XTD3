...
VAR_INFO = {
  ...
  CSV_INPUT_COLUMN_DELIMITER: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_INPUT_COLUMN_DELIMITER', VAR_LIMITS: (1, 1)},
  CSV_INPUT_QUOTE_CHAR: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_INPUT_QUOTE_CHAR', VAR_LIMITS: (1, 1)},
  CSV_OUTPUT_CONVERT_CR_NL: {VAR_TYPE: TYPE_BOOLEAN, VAR_ENVVAR: u'GAM_CSV_OUTPUT_CONVERT_CR_NL'},
  CSV_OUTPUT_COLUMN_DELIMITER: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_COLUMN_DELIMITER', VAR_LIMITS: (1, 1)},
  CSV_OUTPUT_FIELD_DELIMITER: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_FIELD_DELIMITER', VAR_LIMITS: (1, 1)},
  CSV_OUTPUT_LINE_TERMINATOR: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_LINE_TERMINATOR', VAR_LIMITS: (1, 2)},
  CSV_OUTPUT_QUOTE_CHAR: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_QUOTE_CHAR', VAR_LIMITS: (1, 1)},
  ...
  INTER_BATCH_WAIT: {VAR_TYPE: TYPE_INTEGER, VAR_ENVVAR: u'GAM_INTER_BATCH_WAIT', VAR_LIMITS: (0, 60)},
  ...
  NUM_TBATCH_THREADS: {VAR_TYPE: TYPE_INTEGER, VAR_ENVVAR: u'GAM_TBATCH_THREADS', VAR_LIMITS: (1, 100)},
  ...
  PRINT_NATIVE_NAMES: {VAR_TYPE: TYPE_BOOLEAN, VAR_ENVVAR: u'GAM_PRINT_NATIVE_NAMES'},
  SECTION: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: u'GAM_SECTION', VAR_LIMITS: (0, None)},
  SHOW_CONVERT_CR_NL: {VAR_TYPE: TYPE_BOOLEAN, VAR_ENVVAR: u'GAM_SHOW_CONVERT_CR_NL'},
  SHOW_COUNTS_MIN: {VAR_TYPE: TYPE_INTEGER, VAR_ENVVAR: u'GAM_SHOW_COUNTS_MIN', VAR_LIMITS: (0, 100)},
