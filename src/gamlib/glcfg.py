...
VAR_INFO = {
  ...
  CSV_INPUT_COLUMN_DELIMITER: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_INPUT_COLUMN_DELIMITER'},
  CSV_INPUT_QUOTE_CHAR: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_INPUT_QUOTE_CHAR'},
  CSV_OUTPUT_CONVERT_CR_NL: {VAR_TYPE: TYPE_BOOLEAN, VAR_ENVVAR: u'GAM_CSV_OUTPUT_CONVERT_CR_NL'},
  CSV_OUTPUT_COLUMN_DELIMITER: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_COLUMN_DELIMITER'},
  CSV_OUTPUT_FIELD_DELIMITER: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_FIELD_DELIMITER'},
  CSV_OUTPUT_LINE_TERMINATOR: {VAR_TYPE: TYPE_CHOICE, VAR_ENVVAR: u'GAM_CSV_OUTPUT_LINE_TERMINATOR', VAR_CHOICES: {u'cr': u'\r', u'lf': u'\n', u'crlf': u'\r\n'}},
  CSV_OUTPUT_QUOTE_CHAR: {VAR_TYPE: TYPE_CHARACTER, VAR_ENVVAR: u'GAM_CSV_OUTPUT_QUOTE_CHAR'},
