...
VAR_INFO = {
  ...
  CHARSET: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: 'GAM_CHARSET'},
  ...
  CUSTOMER_ID: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: 'CUSTOMER_ID'},
  ...
  DOMAIN: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: 'GA_DOMAIN'},
  ...
  SECTION: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: 'GAM_SECTION'},
  ...
  TODRIVE_USER: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: 'GAM_TODRIVE_USER'},
  TODRIVE_PARENT: {VAR_TYPE: TYPE_STRING, VAR_ENVVAR: 'GAM_TODRIVE_PARENT'},
